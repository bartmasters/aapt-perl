<?xml version="1.0" ?>
<!-- $Id: test.bill-email-tempinv-txt.xsl,v 1.7 2005/03/30 07:50:00 bamaster Exp $ -->
...
* Type in your temporary Invoice Number as your Password <xsl:value-of select="temp_invoice_number"/>.
* Press 'Submit'.

Once logged in, you'll be prompted to enter your own password.
