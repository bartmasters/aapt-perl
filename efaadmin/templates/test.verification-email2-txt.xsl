<?xml version="1.0" ?>
<!-- $Id: test.verification-email2-txt.xsl,v 1.4 2005/01/21 00:25:27 sviles Exp $ -->
...
This is the second email to verify your <xsl:value-of select="subscription_type"/> Subscription.
