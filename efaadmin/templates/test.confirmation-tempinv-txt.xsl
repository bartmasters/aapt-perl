<?xml version="1.0" ?>
<!-- $Id: test.confirmation-tempinv-txt.xsl,v 1.1 2005/01/21 00:25:27 sviles Exp $ -->
...
and type in your Account Number <xsl:value-of select="account_number"/>. Instead of a password,
you can use this temporary invoice number <xsl:value-of select="temp_invoice_number"/> to log in. 
