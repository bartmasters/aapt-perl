<?xml version="1.0" ?>
<!-- $Id: test.verification-email2-html.xsl,v 1.2 2005/01/21 00:25:27 sviles Exp $ -->
...
<!-- we use xsl:text to preserve the blank line, otherwise <xsl:output method="html"> will strip it -->
		<html>
			...
			<p>This is the second email to verify your <xsl:value-of select="subscription_type"/> Subscription.</p>
